...
public class PythonInterpreter extends Interpreter {
  ...
  private void createPythonScript() throws IOException {
    ...
    copyResourceToPythonWorkDir("python/py4j-src-0.10.9.5.zip", "py4j-src-0.10.9.5.zip");
  }
  ...
  protected Map<String, String> setupPythonEnv() throws IOException {
    ...
    if (useBuiltinPy4j) {
      appendToPythonPath(env, pythonWorkDir.getAbsolutePath() + "/py4j-src-0.10.9.5.zip");
    }
